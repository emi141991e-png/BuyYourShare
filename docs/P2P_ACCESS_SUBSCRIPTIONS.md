...
La riconciliazione supporta anche PaymentIntent Stripe storici salvati impropriamente nel campo subscription: solo ID pi_ esplicitamente autorizzati, letti con API 2024-06-20, pagamento EUR riuscito e charge pagata/non rimborsata, senza invoice. Nessuna scrittura presso Stripe. Il credito termina al minimo tra fine mese verificata e scadenza già registrata; veri ID sub_ e pagamenti collegati a fatture restano bloccati per riconciliazione. Credenziali Stripe esistenti riusate in sola lettura.
